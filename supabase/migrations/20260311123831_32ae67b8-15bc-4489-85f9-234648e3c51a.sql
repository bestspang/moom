...
BEGIN
  ...
  LOOP
    ...
    IF v_extra IS NOT NULL AND v_extra != '{}'::jsonb AND v_extra != 'null'::jsonb THEN
      ...
      -- Diamond: challenge_min (monthly OR seasonal) in challenge_window_days
      ...
      -- Black: extra_2of4 — must meet at least 2 of 4 criteria
      IF v_extra_met AND v_extra ? 'extra_2of4' THEN
        ...
        BEGIN
          -- seasonal_badge: at least 1 seasonal badge
          ...
          -- referral_conversion: at least 1 completed referral
          ...
          -- monthly_quest_2: at least 2 monthly quests completed in 90d
          ...
          -- community_event_2: at least 2 community events in 90d (from sp_ledger)
