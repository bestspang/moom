...
-- Fix process_package_sale: correct enum names
-- Bug: p_type::transaction_type → enum doesn't exist (real name is package_type)
-- Bug: 'completed'::transaction_status → invalid value (must be 'paid')
...
BEGIN
  ...
  INSERT INTO transactions (
    ...
    p_transaction_no, p_member_id, p_package_id, p_order_name, p_type::package_type,
    p_amount, p_payment_method::payment_method, 'paid'::transaction_status,
