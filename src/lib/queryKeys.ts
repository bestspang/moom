export const queryKeys = {
  ...
  classes: (status?: string, search?: string, typeFilter?: string, categoryFilter?: string, levelFilter?: string) => ['classes', status, search, typeFilter, categoryFilter, levelFilter] as const,
