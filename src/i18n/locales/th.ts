export default {
  maintenance: {
    ...
    subtitle: 'ขออภัย เว็บไซต์อยู่ระหว่างการปรับปรุงชั่วคราว',
    body: 'เรากำลังอัปเดตระบบให้ดียิ่งขึ้น กรุณากลับมาใหม่ในภายหลัง',
  },
  // Common
  common: {
    save: 'บันทึก',
  ...
  lobby: {
    ...
    help: {
      filters: 'กรองตามสาขา วิธีเช็คอิน หรือประเภทแพ็คเกจ คลิกที่แถวเพื่อดูรายละเอียด',
      checkInButton: 'สร้างการเช็คอินให้สมาชิกด้วยตนเอง',
      qrButton: 'แสดง QR สำหรับคีออสก์ให้สมาชิกเช็คอินเอง',
    },
  },
  ...
  settings: {
    ...
    maintenance: {
      ...
      description: 'เมื่อเปิดใช้งาน ผู้ใช้ทั่วไปจะเห็นหน้า "กำลังปรับปรุงระบบ" แทนหน้าแอป แอดมินยังสามารถเข้าสู่ระบบได้ที่ /admin',
      cardTitle: 'ปิดปรับปรุงเว็บไซต์ / Coming Soon',
      status: 'สถานะปัจจุบัน',
      enabled: 'เปิดอยู่ — ผู้ใช้เห็นหน้าปรับปรุง',
      disabled: 'ปิดอยู่ — เว็บไซต์ใช้งานปกติ',
      toggleLabel: 'เปิดโหมดปิดปรับปรุง',
      warning: 'เมื่อเปิดใช้งาน สมาชิก เทรนเนอร์ และสตาฟทั้งหมดจะไม่สามารถเข้าใช้งานได้ทันที เฉพาะแอดมินที่เข้าผ่าน /admin เท่านั้นที่ยังใช้งานได้',
      adminHint: 'แอดมินสามารถเข้าสู่ระบบได้ที่ /admin เสมอ แม้ในขณะเปิดโหมดปิดปรับปรุง',
      enabledToast: 'เปิดโหมดปิดปรับปรุงแล้ว',
      disabledToast: 'ปิดโหมดปิดปรับปรุงแล้ว',
      toggleFailed: 'ไม่สามารถอัปเดตโหมดปิดปรับปรุงได้',
      menu: 'โหมดปิดปรับปรุง',
    },
    branding: {
      identityMenu: 'อัตลักษณ์แบรนด์',
      colorsMenu: 'สี',
      typographyMenu: 'ฟอนต์',
      assetsMenu: 'โลโก้และไฟล์',
      identityDesc: 'ชื่อยิม สโลแกน และสิ่งที่ทำให้สมาชิกจดจำแบรนด์ของคุณในทุกหน้าจอ',
      brandName: 'ชื่อแบรนด์',
      brandNameDesc: 'แสดงในเมนูด้านข้าง หัวแอพสมาชิก ใบเสร็จ และอีเมล',
      taglineTitle: 'สโลแกนและคำอธิบาย',
      taglineDesc: 'คำอธิบายสั้นๆ ที่แสดงในหน้าสมัครสมาชิกและลิงก์แชร์',
      colorsDesc: 'ปรับสีหลัก สีรอง และโทนพื้นหลังของแบรนด์ การเปลี่ยนแปลงจะมีผลทั่วทั้งระบบ',
      primaryPaletteTitle: 'พาเลตต์หลัก',
      primaryPaletteDesc: 'เลือกสีหลัก สีรอง และสีเน้น พร้อมพรีวิวสด',
      tokenHint: 'ขับเคลื่อนด้วยระบบโทเคน —',
      typographyDesc: 'เลือกฟอนต์ที่เข้ากับบุคลิกของแบรนด์',
      fontFamilyTitle: 'ตระกูลฟอนต์',
      fontFamilyDesc: 'เลือกได้ทั้ง Anuphan, IBM Plex, Sarabun, Prompt และอื่นๆ',
      assetsDesc: 'อัปโหลดโลโก้และไฟล์แบรนด์ ใช้ทั่วทั้งแอพ admin, สมาชิก และเทรนเนอร์',
      logoUploadTitle: 'อัปโหลดโลโก้',
      logoUploadDesc: 'รองรับแบบสี่เหลี่ยม วงกลม และเวิร์ดมาร์ค ไฟล์ PNG / SVG ไม่เกิน 2MB',
      pageTitle: 'แบรนด์ยิม',
      pageSubtitle: 'กำหนดอัตลักษณ์แบรนด์ของคุณ — ทุกการเปลี่ยนแปลงแสดงทันทีในตัวอย่าง',
      exportKit: 'ส่งออก Brand Kit',
      reset: 'รีเซ็ต',
      resetConfirm: 'รีเซ็ตเป็นค่าเริ่มต้น? การเปลี่ยนแปลงที่ยังไม่บันทึกจะหายไป',
      dirty: 'มีการเปลี่ยนแปลงที่ยังไม่บันทึก',
      savedToast: 'บันทึกแบรนด์เรียบร้อย',
      revertedToast: 'ยกเลิกการเปลี่ยนแปลงแล้ว',
      resetToast: 'รีเซ็ตเป็นค่าเริ่มต้นแล้ว',
      exportedToast: 'ดาวน์โหลด Brand Kit แล้ว',
      previewLabel: 'ตัวอย่างสด',
      sectionIdentity: 'ตัวตน',
      sectionIdentitySub: 'ชื่อและข้อความของแบรนด์',
      sectionLogo: 'โลโก้',
      sectionLogoSub: 'รูปแบบและการแสดงผล',
      sectionColors: 'สีของแบรนด์',
      sectionColorsSub: 'สีหลัก สีรอง สีเน้น และพื้นหลัง',
      sectionType: 'ตัวอักษร',
      sectionTypeSub: 'ฟอนต์และน้ำหนัก',
      sectionPhoto: 'รูปภาพ',
      sectionPhotoSub: 'อารมณ์ของภาพถ่ายและฟิลเตอร์',
      sectionSocial: 'โซเชียล & เว็บไซต์',
      sectionSocialSub: 'ลิงก์ที่จะปรากฏในแอปและใบเสร็จ',
      sectionContact: 'ติดต่อ',
      sectionContactSub: 'ข้อมูลสำหรับลูกค้า',
      tagline: 'สโลแกน',
      about: 'เกี่ยวกับเรา',
      aboutHint: 'ข้อความแนะนำสั้นๆ',
      logoLetter: 'ตัวอักษรโลโก้',
      logoLetterHint: 'ตัวอักษรบนโลโก้',
      logoStyle: 'รูปแบบโลโก้',
      logoSquare: 'เหลี่ยมมน',
      logoCircle: 'วงกลม',
      ...
      accent: 'สีเน้น',
      surface: 'พื้นหลัง',
      colorTip: 'เคล็ดลับ: ใช้สีหลัก 60%, สีรอง 30%, สีเน้น 10% เพื่อความสมดุล',
      brandFont: 'ฟอนต์แบรนด์',
      fontWeight: 'น้ำหนักหัวเรื่อง',
      photoStyle: 'สไตล์ภาพ',
      photoWarm: 'อบอุ่น',
      photoCool: 'คูล',
      photoMono: 'ขาวดำ',
      ...
      contactAddr: 'ที่อยู่',
      fontMood: {
        modernWarm: 'โมเดิร์น · อบอุ่น',
        cleanTech: 'สะอาด · เทคนิค',
        neutralRead: 'เป็นกลาง · อ่านง่าย',
      ...
      noAccessBody: 'คุณไม่มีสิทธิ์ดูหน้าตั้งค่าแบรนด์ กรุณาติดต่อผู้ดูแลระบบ',
      readOnlyBanner: 'โหมดอ่านอย่างเดียว — บทบาทของคุณไม่สามารถแก้ไขแบรนด์ได้',
      writeBlockedToast: 'คุณไม่มีสิทธิ์บันทึกการเปลี่ยนแปลงแบรนด์',
      saveErrorToast: 'บันทึกการเปลี่ยนแปลงไม่สำเร็จ กรุณาลองอีกครั้ง',
      uploadLogo: 'อัปโหลดโลโก้',
      uploadPhoto: 'อัปโหลดภาพแบรนด์',
      uploadBrowse: 'เลือกไฟล์',
      uploadCurrent: 'ไฟล์ปัจจุบัน',
      uploadRemove: 'ลบ',
      uploadProgress: 'กำลังอัปโหลด...',
      uploadSuccess: 'อัปโหลดสำเร็จ',
      uploadFailed: 'อัปโหลดไม่สำเร็จ ลองอีกครั้ง',
      uploadInvalidType: 'รองรับเฉพาะไฟล์ {{formats}}',
      uploadTooLarge: 'ไฟล์ใหญ่เกินไป สูงสุด {{max}}',
      uploadDimensionsTooSmall: 'ภาพเล็กเกินไป ขั้นต่ำ {{min}} (ปัจจุบัน {{actual}})',
      uploadDimensionsTooLarge: 'ภาพใหญ่เกินไป สูงสุด {{max}} (ปัจจุบัน {{actual}})',
      uploadUnreadable: 'อ่านไฟล์ภาพไม่ได้',
      uploadHint: '{{formats}} · สูงสุด {{max}} · ขั้นต่ำ {{min}}',
      dragDropHint: 'ลากไฟล์มาวาง หรือคลิกเพื่อเลือก',
    },
    general: {
      // Sidebar menu
  ...
  support: {
    public: {
      title: 'ขอความช่วยเหลือ / ร้องเรียน',
      subtitle: 'บอกเราได้เลย เราจะติดต่อกลับโดยเร็ว',
      anonymous: 'ไม่ประสงค์ออกนาม',
      anonymousHint: 'ซ่อนชื่อของคุณจากทีมงาน (ข้อมูลติดต่อยังกรอกได้)',
      anonymousShort: 'ไม่ประสงค์ออกนาม',
      name: 'ชื่อของคุณ',
      namePlaceholder: 'เช่น สมชาย',
      phone: 'เบอร์โทร (ไม่บังคับ)',
      email: 'อีเมล (ไม่บังคับ)',
      invalidPhone: 'รูปแบบเบอร์โทรไม่ถูกต้อง',
      invalidPhoneTH: 'กรุณากรอกเบอร์ 10 หลักขึ้นต้นด้วย 0 (เช่น 081-234-5678)',
      invalidEmail: 'รูปแบบอีเมลไม่ถูกต้อง',
      category: 'หัวข้อ',
      categoryPlaceholder: 'เลือกหัวข้อ',
      categoryRequired: 'กรุณาเลือกหัวข้อ',
      subject: 'เรื่อง',
      subjectPlaceholder: 'สรุปสั้น ๆ',
      subjectRequired: 'กรุณากรอกเรื่อง',
      message: 'รายละเอียด',
      messagePlaceholder: 'อธิบายเรื่องที่ต้องการแจ้ง (อย่างน้อย 10 ตัวอักษร)',
      messageRequired: 'กรุณากรอกอย่างน้อย 10 ตัวอักษร',
      messageHint: 'ยิ่งให้รายละเอียดมากเท่าไร เราก็ยิ่งช่วยเหลือได้ดีเท่านั้น',
      submit: 'ส่งเรื่อง',
      submitting: 'กำลังส่ง…',
      submitFailed: 'ส่งเรื่องไม่สำเร็จ กรุณาลองใหม่อีกครั้ง',
      throttled: 'กรุณารอสักครู่ก่อนส่งอีกครั้ง',
      privacyNote: 'ข้อมูลติดต่อจะใช้เพื่อการตอบกลับเท่านั้น',
      successTitle: 'ส่งเรื่องเรียบร้อย',
      successDesc: 'ขอบคุณสำหรับข้อความ ทีมงานจะติดต่อกลับโดยเร็ว',
      ticketNo: 'หมายเลขอ้างอิง',
      submitAnother: 'ส่งเรื่องใหม่',
      phoneRewardHint: '📱 เฉพาะหัวข้อ "ข้อเสนอแนะ" หรือ "ร้องเรียน" + กรอกเบอร์ที่ใช้สมัครสมาชิก รับ +{{xp}} XP และ +{{coin}} Coin (สูงสุด 1 ครั้ง / 2 สัปดาห์)',
      pointsAwardedTitle: '🎉 คุณได้รับคะแนน!',
      pointsAwardedDesc: '+{{xp}} XP และ +{{coin}} Coin เข้าบัญชีสมาชิกแล้ว',
      noMemberMatch: 'เบอร์ที่กรอกไม่ตรงกับสมาชิกในระบบ จึงไม่ได้รับคะแนน',
      reward: {
        granted: 'ได้รับ +{{xp}} XP และ +{{coin}} Coin เข้าบัญชีสมาชิกแล้ว 🎉',
        cooldown: 'คุณเพิ่งได้รับรางวัลจากการส่งความคิดเห็นไปแล้วในช่วง 14 วันที่ผ่านมา รางวัลถัดไปจะปลดล็อกเร็ว ๆ นี้',
        noMember: 'ไม่พบเบอร์นี้ในระบบสมาชิก จึงยังไม่ได้รับรางวัลครั้งนี้ — ครั้งถัดไปลองใช้เบอร์ที่ลงทะเบียนไว้',
        noPhone: 'หากใส่เบอร์ที่ใช้สมัครสมาชิก จะได้รับ +{{xp}} XP และ +{{coin}} Coin ทุก 14 วัน',
        ineligibleCategory: 'รางวัลมีเฉพาะหัวข้อ "ข้อเสนอแนะ" และ "ร้องเรียน" — ขอบคุณสำหรับข้อความของคุณ',
        tryLater: 'ระบบรางวัลขัดข้องชั่วคราว ทีมงานจะตรวจสอบให้',
        titleGranted: '🎉 คุณได้รับรางวัล',
        titleSkipped: 'สถานะรางวัล',
      },
      langToggle: 'EN',
    },
    category: {
    ...
    admin: {
      title: 'ข้อร้องเรียน',
      description: 'เรื่องที่ลูกค้าส่งเข้ามาผ่านหน้า Support สาธารณะ',
      allCategories: 'ทุกหัวข้อ',
      allPriorities: 'ทุกระดับ',
      searchPlaceholder: 'ค้นหาหมายเลข เรื่อง หรือข้อมูลติดต่อ…',
      emptyTitle: 'ยังไม่มีข้อร้องเรียน',
      emptyDesc: 'เรื่องใหม่จะแสดงที่นี่แบบเรียลไทม์',
      dateFrom: 'จากวันที่',
      dateTo: 'ถึงวันที่',
      clearFilters: 'ล้างตัวกรอง',
      ...
      noContact: 'ไม่ได้ให้ข้อมูลติดต่อ',
      setStatus: 'สถานะ',
      setPriority: 'ความสำคัญ',
      setAssignee: 'ผู้รับผิดชอบ',
      internalNote: 'บันทึกภายใน',
      internalNotePlaceholder: 'บันทึกสำหรับทีมงาน (ผู้ส่งเรื่องมองไม่เห็น)',
      assignToMe: 'มอบหมายให้ฉัน',
      save: 'บันทึก',
      updated: 'อัปเดตเรียบร้อย',
      updateFailed: 'อัปเดตไม่สำเร็จ',
      noteAdded: 'เพิ่มบันทึกแล้ว',
      noteFailed: 'เพิ่มบันทึกไม่สำเร็จ',
      detail: {
        back: 'กลับไปหน้ารายการ',
        requester: 'ผู้ส่งเรื่อง',
        timeline: 'ประวัติการดำเนินการ',
        timelineEmpty: 'ยังไม่มีการดำเนินการ',
        internalNotes: 'เพิ่มบันทึกภายใน',
        notePlaceholder: 'บันทึกจะเห็นได้เฉพาะทีมงาน',
        postNote: 'โพสต์บันทึก',
        workflow: 'จัดการเรื่อง',
        metadata: 'รายละเอียด',
    ...
    timeline: {
      created: 'ส่งเรื่องเข้ามา',
      status_changed: 'เปลี่ยนสถานะจาก {{from}} เป็น {{to}}',
      priority_changed: 'เปลี่ยนความสำคัญจาก {{from}} เป็น {{to}}',
      assigned: 'มอบหมายให้ {{to}}',
      reopened: 'เปิดเรื่องอีกครั้ง',
