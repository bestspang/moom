export default {
  ...
  staff: {
    ...
    emergencyRelationship: 'ความสัมพันธ์',
    scanQrCodes: 'สแกน QR สมาชิก',
    qrScannerComingSoon: 'สแกนเนอร์ QR เร็วๆ นี้',
    qrScannerDescription: 'คุณจะสามารถสแกน QR เช็คอินของสมาชิกได้ที่นี่',
    transferSlips: 'สลิปโอนเงิน',
    noSlips: 'ไม่มีสลิป',
    slipsWillAppear: 'สลิปโอนเงินจะแสดงที่นี่',
    searchAndManage: 'ค้นหาและจัดการ',
