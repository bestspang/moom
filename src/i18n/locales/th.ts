export default {
  ...
  settings: {
    ...
    client: {
      ...
      bookOnMobile: 'จองบนแอพ MOOM CLUB',
      bookOnConsole: 'จองบน MOOM CLUB Console',
    },
    package: {
      expiration: 'วันหมดอายุ',
      expirationConditions: 'กำหนดเงื่อนไขสำหรับเปิดใช้งานแพ็คเกจเพื่อเริ่มนับถอยหลังวันหมดอายุ',
      whenBooking: 'เมื่อจองคลาส',
    },
    memberContracts: {
      allowSigning: 'อนุญาตให้สมาชิกลงนามสัญญาในแอพสมาชิก',
      signingDescription: 'เมื่อเปิดใช้งาน สมาชิกจะได้รับการแจ้งเตือนให้ลงนามสัญญาในแอพสมาชิก',
