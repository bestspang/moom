export default {
  ...
  reports: {
    ...
    // New report titles
    activeMembersTitle: 'Active Members (Cumulative)',
    activeMembersDesc: 'Shows the number of active members at this fitness center (cumulative)',
    membersAtRiskDesc: 'Shows members at risk by remaining sessions and package expiry',
    packageUsageDesc: 'Shows package usage overview within the selected time period',
    packageAtRiskDesc: 'Shows at-risk member packages based on remaining sessions and expiry date',
    classCapacityByHourTitle: 'Class Capacity by Hour of Day',
    classCapacityByHourDesc: 'Shows class capacity for every hour of the day',
    classCapacityTitle: 'Class Capacity (Cumulative)',
    classCapacityDesc: 'Shows class capacity over time (cumulative)',
    classCategoryPopularityDesc: 'Shows category ranking by class capacity',
    classPopularityDesc: 'Shows class ranking by attendance or capacity',
    packageSalesTitle: 'Package Sales',
    packageSalesDesc: 'Shows package sales comparison by units sold and revenue',
    packageSalesOverTimeTitle: 'Package Sales (Cumulative)',
    packageSalesOverTimeDesc: 'Shows package sales trend by units sold and revenue (cumulative)',
    // Buttons
