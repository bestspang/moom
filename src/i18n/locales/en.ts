export default {
  ...
  announcements: {
    ...
    aiDraftHint: 'Type a topic in the message, then generate an EN + TH draft',
    aiDraftNeedTopic: 'Type a topic or a rough message first, then tap AI Draft',
    aiDraftDone: 'Draft generated',
    aiDraftError: 'Could not generate a draft. Please try again.',
