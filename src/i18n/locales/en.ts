export default {
  ...
  roadmap: {
    ...
    memberApp: {
      ...
      features: {
        ...
        momentum: 'Streaks & momentum',
        squad: 'Squad community',
      },
      menu: {
        ...
        badgesDesc: 'Your achievements',
        leaderboard: 'Leaderboard',
        leaderboardDesc: 'XP rankings',
        momentum: 'Momentum',
        momentumDesc: 'Streaks & levels',
        squad: 'Squad',
        squadDesc: 'Your fitness community',
      },
      nav: {
        home: 'Home',
        book: 'Book',
    ...
    trainerApp: {
      ...
      menu: {
        ...
        impact: 'Coach Impact',
        impactDesc: 'Your reputation & ratings',
        badges: 'Badges',
        badgesDesc: 'Earned achievements',
      },
      nav: {
        home: 'Home',
        schedule: 'Schedule',
  ...
  members: {
    ...
    confirmDeleteBilling: 'Are you sure you want to delete this billing record?',
    billingDescription: 'Description',
    billingAmount: 'Amount',
    billingDate: 'Billing date',
    billingTransaction: 'Transaction (optional)',
    ...
    activateConfirm: 'Activate this package now? Dates will be set automatically.',
  ...
  staff: {
    ...
    checkinSubtitle: 'Scan member QR codes',
    checkinKioskTitle: 'Kiosk Check-in Display',
    checkinKioskDescription: 'Open the kiosk display on a tablet or screen. Members scan the QR code shown on screen to check in.',
    launchKiosk: 'Launch Kiosk Display',
    checkinKioskHint: 'Opens in a new tab — ideal for a front-desk tablet or TV.',
    membersTitle: 'Members',
    membersSubtitle: 'Search and manage',
    noMembersFound: 'No members found',
    tryDifferentSearch: 'Try a different search term',
    membersWillAppear: 'Members will appear here',
    paymentsTitle: 'Payments',
    paymentsSubtitle: 'Transfer slips',
    noSlips: 'No slips',
  ...
  settings: {
    ...
    branding: {
      ...
      colorsMenu: 'Colors',
      typographyMenu: 'Typography',
      assetsMenu: 'Logo & assets',
      identityDesc: 'Your gym name, tagline, and how members recognize your brand across all surfaces.',
      brandName: 'Brand name',
      brandNameDesc: 'Shown in the sidebar, member app header, receipts, and emails.',
      taglineTitle: 'Tagline & about',
      taglineDesc: 'A short description shown on the member sign-up screen and shareable links.',
      colorsDesc: 'Adjust your primary brand color, accents, and surface tints. Changes apply system-wide.',
      primaryPaletteTitle: 'Primary palette',
      primaryPaletteDesc: 'Pick your primary, secondary, and accent colors. Live preview included.',
      tokenHint: 'Powered by token-driven theming —',
      typographyDesc: 'Choose the typeface that best matches your brand voice.',
      fontFamilyTitle: 'Font family',
      fontFamilyDesc: 'Pick from Anuphan, IBM Plex, Sarabun, Prompt, and more.',
      assetsDesc: 'Upload your logo and brand assets. Used across the admin, member, and trainer apps.',
      logoUploadTitle: 'Logo upload',
      logoUploadDesc: 'Square, circle, and wordmark variants. PNG / SVG up to 2MB.',
      pageTitle: 'Brand',
      pageSubtitle: 'Define your brand identity — every change shows in the preview instantly.',
      exportKit: 'Export Brand Kit',
      reset: 'Reset',
      resetConfirm: 'Reset to defaults? Unsaved changes will be lost.',
      dirty: 'You have unsaved changes',
      savedToast: 'Brand saved',
      revertedToast: 'Reverted changes',
      resetToast: 'Reset to defaults',
      exportedToast: 'Brand Kit downloaded',
      previewLabel: 'Live preview',
      sectionIdentity: 'Identity',
      sectionIdentitySub: 'Brand name and copy',
      sectionLogo: 'Logo',
      sectionLogoSub: 'Style and display',
      sectionColors: 'Brand colors',
      sectionColorsSub: 'Primary, secondary, accent, and surface',
      sectionType: 'Typography',
      sectionTypeSub: 'Font family and weight',
      sectionPhoto: 'Photography',
      sectionPhotoSub: 'Mood and image filter',
      sectionSocial: 'Social & web',
      sectionSocialSub: 'Links shown in app and receipts',
      sectionContact: 'Contact',
      sectionContactSub: 'Customer-facing details',
      tagline: 'Tagline',
      about: 'About',
      aboutHint: 'A short pitch',
      logoLetter: 'Logo letter',
      logoLetterHint: 'Mark on the logo',
      logoStyle: 'Logo style',
      logoSquare: 'Rounded square',
      logoCircle: 'Circle',
      ...
      accent: 'Accent',
      surface: 'Surface',
      colorTip: 'Tip: 60% primary, 30% secondary, 10% accent for balance.',
      ...
      contactAddr: 'Address',
      fontMood: {
        modernWarm: 'Modern · Warm',
        cleanTech: 'Clean · Technical',
        neutralRead: 'Neutral · Readable',
      ...
      uploadBrowse: 'Browse',
      uploadCurrent: 'Current file',
      uploadRemove: 'Remove',
      uploadProgress: 'Uploading...',
      uploadSuccess: 'Upload successful',
      uploadFailed: 'Upload failed, please try again',
      uploadInvalidType: 'Only {{formats}} files are supported',
      uploadTooLarge: 'File too large, max {{max}}',
      uploadDimensionsTooSmall: 'Image too small, min {{min}} (current {{actual}})',
      uploadDimensionsTooLarge: 'Image too large, max {{max}} (current {{actual}})',
      uploadUnreadable: 'Could not read image file',
      uploadHint: '{{formats}} · max {{max}} · min {{min}}',
      dragDropHint: 'Drag a file here or click to choose',
    },
    general: {
      // Sidebar menu
  ...
  member: {
    ...
    goodEvening: 'Good evening',
    // NextUpCard states
    nextUpEyebrow: 'Today · {{time}}',
    todayLabel: 'Today',
    classDefault: 'Class',
    viewDetails: 'View details',
    checkedInEyebrow: 'Checked in · {{time}}',
    checkedInToday: 'Checked in today',
    checkedInTitle: 'Nice work! Check-in recorded',
    checkedInSub: 'Book your next session to keep the streak alive',
    viewProgress: 'View progress',
    bookNext: 'Book next',
    todayOpen: 'Your day is open',
    bookNextClass: 'Book your next class',
    scheduleHint: 'Browse the schedule to find the right class',
    viewSchedule: 'View schedule',
    justCheckIn: 'Just check in',
    // Quick tiles
    quickBook: 'Book',
    quickHistory: 'History',
    quickFriends: 'Friends',
    ...
    change: 'Change',
    // V2 visual refresh
    greetingMorning: 'Ready this morning!',
    greetingAfternoon: 'Ready this afternoon!',
    greetingEvening: 'Ready tonight!',
    mascotTagline: 'Moomu is ready to train with you 💪',
    mood: {
      tired: 'Tired',
      ok: 'Meh',
      good: 'Good',
    ...
    questsProgress: 'Done {{done}}/{{total}} · {{xp}} XP left to earn',
    almostUnlocked: 'Almost unlocked',
    almostUnlockedSub: '{{n}} more · {{current}}/{{target}}',
    dailySpinTag: 'Daily spin',
    dailySpinTitle: 'Spin to win a free reward',
    dailySpinSub: 'Once per day',
    dailySpinCta: 'Spin!',
    referralBigTitle: 'Invite friends, earn coins!',
    referralBigSub: 'Share your code, both get 200 Coins',
    checkedInTodayCount: '{{n}} friends checked in today 💪',
    friendsPulseSubAt: 'Your friends are at {{name}}',
    wellnessTipTag: 'Wellness · Breathing',
    // V1 widgets
    ...
    comingSoon: 'Coming soon',
    tip1: 'Drink a glass of water before training to keep muscles primed.',
    tip2: 'Rest 60-90 seconds between sets for better recovery.',
    tip3: 'Master the technique before adding weight to prevent injury.',
    tip4: 'Sleep 7-9 hours per night — it is the key to muscle growth.',
    tip5: 'Warm up 5-10 minutes before every workout, no exceptions.',
    tip6: 'Eat protein within 30 minutes post-workout to aid recovery.',
  ...
  gamification: {
    ...
    coupons: {
      description: 'Manage coupon templates for merch, packages, and events.',
      addCoupon: 'Add Coupon',
      noCoupons: 'No coupon templates',
      noCouponsDesc: 'Create coupon templates to offer discounts through the reward system.',
      editCoupon: 'Edit Coupon Template',
      createCoupon: 'Create Coupon Template',
      nameEn: 'Name (EN)',
      nameTh: 'Name (TH)',
      ...
      appliesToAll: 'All',
      appliesToMerch: 'Merch',
      appliesToPackage: 'Package',
      appliesToEvent: 'Event',
      stackable: 'Stackable',
      colName: 'Name',
      colType: 'Type',
      colMinSpend: 'Min Spend',
      colAppliesTo: 'Applies To',
      colValidDays: 'Valid Days',
      colActive: 'Active',
    },
    quests: {
      description: 'Manage daily, weekly, monthly, and seasonal quest templates.',
      addQuest: 'Add Quest',
      noQuests: 'No quest templates',
      noQuestsDesc: 'Create your first quest template to start assigning quests to members.',
      editQuest: 'Edit Quest Template',
      createQuest: 'Create Quest Template',
      daily: 'Daily',
      weekly: 'Weekly',
      monthly: 'Monthly',
      seasonal: 'Seasonal',
      ...
      audienceTrainerInhouse: 'Trainer (In-house)',
      audienceTrainerFreelance: 'Trainer (Freelance)',
      goal: 'Goal',
      goalType: 'Goal Type',
      goalActionCount: 'Action Count',
      goalXpThreshold: 'XP Threshold',
      goalClassCount: 'Class Count',
      goalStreak: 'Streak',
    ...
    shopRules: {
      description: 'Configure XP and Coin earn rules for shop purchases.',
      addRule: 'Add Rule',
      noRules: 'No shop rules',
      noRulesDesc: 'Configure how purchases earn XP and Coin.',
      editRule: 'Edit Shop Rule',
      createRule: 'Create Shop Rule',
      ...
      xpPerOrder: 'XP/Order',
      xpPerUnit: 'XP/Unit',
      xpPerSpendUnit: 'XP/Spend Unit',
      xpCap: 'XP Cap',
      coinRules: 'Coin Rules',
      spendUnit: 'Spend Unit (฿)',
      coinPerUnit: 'Coin/Unit',
      coinCap: 'Coin Cap',
      requiredLevel: 'Required Level',
    },
    operations: {
      title: 'Manual Operations',
      description: 'Perform controlled manual adjustments. All operations are logged to the audit trail.',
      operationLabel: 'Operation',
      operationHint: 'Select what you want to do',
      adjustXp: 'Adjust XP',
      adjustXpDesc: 'Add or subtract XP from a member',
      adjustCoin: 'Adjust Coin',
      adjustCoinDesc: 'Add or subtract Coins from a member',
      grantBadge: 'Grant Badge',
      grantBadgeDesc: 'Award a badge to a member',
      revokeBadge: 'Revoke Badge',
      revokeBadgeDesc: 'Remove a badge from a member',
      issueCoupon: 'Issue Coupon',
      issueCouponDesc: 'Issue a coupon to a member',
      memberIdRequired: 'Member ID is required',
      reasonRequired: 'Reason is required for audit trail',
      success: 'Operation completed successfully',
      error: 'Operation failed',
      memberId: 'Member ID (UUID)',
      amountLabel: 'Amount (use negative to subtract)',
    ...
    prestige: {
      title: 'Prestige Tier Criteria (Levels 18–20)',
      description: 'These criteria gate level-up beyond XP requirements. Members must meet ALL active criteria to advance. Changes are system-protected — use caution.',
      updateSuccess: 'Prestige criterion updated',
      criterion: 'Criterion',
      target: 'Target',
      descriptionCol: 'Description',
      noCriteria: 'No criteria configured for this level',
    },
    statusTiers: {
      ...
      qualificationRules: 'Tier Qualification Rules',
      tier: 'Tier',
      minLevel: 'Min Level',
      minSp90d: 'Min SP (90d)',
      activeDays: 'Active Days',
      reqPackage: 'Req. Package',
      members: 'Members',
      spEarningRules: 'Status Point Earning Rules',
      actionKey: 'Action Key',
      spValue: 'SP Value',
      dailyCap: 'Daily Cap',
  ...
  support: {
    public: {
      ...
      subtitle: "Tell us what's on your mind — we'll get back to you.",
      anonymous: 'Submit anonymously',
      anonymousHint: 'Hide your name from staff. Contact info stays optional.',
      ...
      invalidPhone: 'Please enter a valid phone number.',
      invalidPhoneTH: 'Please enter a 10-digit phone starting with 0 (e.g. 081-234-5678).',
      invalidEmail: 'Please enter a valid email.',
      category: 'Topic',
      categoryPlaceholder: 'Choose a topic',
      categoryRequired: 'Please select a topic.',
      subject: 'Subject',
      subjectPlaceholder: 'Short summary',
      subjectRequired: 'Subject is required.',
      message: 'Message',
      messagePlaceholder: 'Describe your issue or feedback (at least 10 characters).',
      messageRequired: 'Please write at least 10 characters.',
      messageHint: 'The more detail you share, the better we can help.',
      submit: 'Submit',
      submitting: 'Sending…',
      submitFailed: 'Could not send your message. Please try again.',
      throttled: 'Please wait a moment before submitting again.',
      privacyNote: 'Your contact info is only used to reply to your request.',
      successTitle: 'Message sent',
      successDesc: "Thanks — we've received your message and will follow up soon.",
      ticketNo: 'Reference number',
      submitAnother: 'Submit another',
      phoneRewardHint: '📱 Only "Suggestion" or "Complaint" + the phone you signed up with earns +{{xp}} XP and +{{coin}} Coin (max 1 per 2 weeks).',
    ...
    admin: {
      ...
      description: 'Requests and complaints submitted through the public support page.',
      allCategories: 'All topics',
      allPriorities: 'All priorities',
      searchPlaceholder: 'Search ticket, subject, contact…',
      emptyTitle: 'No tickets yet',
      emptyDesc: 'New submissions will appear here in real time.',
      dateFrom: 'From date',
      dateTo: 'To date',
      clearFilters: 'Clear filters',
      ...
      internalNotePlaceholder: 'Add a note for the team (not visible to the submitter)',
      ...
      detail: {
        ...
        internalNotes: 'Add internal note',
        notePlaceholder: 'Notes are only visible to the team.',
        postNote: 'Post note',
        workflow: 'Workflow',
        metadata: 'Details',
