    ...
    assignMutation.mutate(
      {
        ...
        promotionId: selectedPromotionId && selectedPromotionId !== 'none' ? selectedPromotionId : undefined,
        promotionDiscount: promotionDiscountAmount,
        couponWalletId: selectedCouponId && selectedCouponId !== 'none' ? selectedCouponId : undefined,
