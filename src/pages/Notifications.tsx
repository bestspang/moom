...
const Notifications = () => {
  ...
  const getTypeLabel = (type: NotificationType) => {
    const labels: Record<NotificationType, string> = {
      ...
      badge_earned: t('notifications.types.badgeEarned'),
      level_up: t('notifications.types.levelUp'),
      challenge_completed: t('notifications.types.challengeCompleted'),
      reward_fulfilled: t('notifications.types.rewardFulfilled'),
      streak_milestone: t('notifications.types.streakMilestone'),
      xp_earned: t('notifications.types.xpEarned'),
      referral_completed: t('notifications.types.referralCompleted'),
